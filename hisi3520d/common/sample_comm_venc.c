...
HI_VOID SAMPLE_COMM_VENC_ChnAttrSet(VENC_CHN VencChn,PIC_SIZE_E enSize,VIDEO_NORM_E enNorm,SAMPLE_RC_E enRcMode)
{
...
//    stH264Cbr.fr32TargetFrmRate = 15;/* target frame rate */
...
//    memcpy(&stVencChnAttr.stRcAttr.stAttrH264Cbr, &stH264Cbr, sizeof(VENC_ATTR_H264_CBR_S));
    ...
    if(SAMPLE_RC_CBR == enRcMode)
    {
        ...
        stH264Cbr.fr32TargetFrmRate = (VIDEO_ENCODING_MODE_PAL== enNorm)?25:15;/* target frame rate */
//        switch (enSize)
//        {
//            case PIC_QCIF:
...
//        }
    ...
    else if (SAMPLE_RC_VBR == enRcMode)
    {
        ...
        stH264Vbr.fr32TargetFrmRate = (VIDEO_ENCODING_MODE_PAL== enNorm)?25:15;
...
/******************************************************************************
* funciton : set venc param
******************************************************************************/
HI_S32 SAMPLE_COMM_VENC_ParamSet(VENC_GRP VencGrp,VENC_CHN VencChn, PAYLOAD_TYPE_E enType, VIDEO_NORM_E enNorm, PIC_SIZE_E enSize, SAMPLE_RC_E enRcMode,VENC_CHN_ATTR_S RateCtr)
{
    ...
    ******************************************/
    ...
    stH264Vbr.u32MaxBitRate=RateCtr.stRcAttr.stAttrH264Vbr.u32MaxBitRate;
    stH264Vbr.fr32TargetFrmRate = RateCtr.stRcAttr.stAttrH264Vbr.fr32TargetFrmRate;

    memcpy(&stVencChnAttr.stRcAttr.stAttrH264Vbr, &stH264Vbr, sizeof(VENC_ATTR_H264_VBR_S));
    SAMPLE_COMM_VENC_ChnAttrSet(VencChn, enSize,enNorm, enRcMode);
